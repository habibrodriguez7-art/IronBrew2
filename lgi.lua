...
local function new(class, props)
    ...
    -- Mematikan UIStroke jika di mobile ATAU jika _G.LowEndMode diaktifkan (untuk PC)
    if (isMobile or _G.LowEndMode) and class == "UIStroke" then
        inst.Enabled = false
    end
...
function Library:CreateCategory(parent, title, startOpen)
    ...
    local function updateCategoryHeight()
        ...
        if isOpen and contentContainer.Visible then
            ...
            contentContainer.Size = UDim2.new(1, 0, 0, ch)
            h = sectionHeaderHeight + ch
        end
...
function Library:MakeNotify(config)
    ...
    local maxNotifs = (isMobile or _G.LowEndMode) and 2 or 5
